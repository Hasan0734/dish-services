...
const Navbar = () => {
  ...
  return (
    <nav className=" bg-white absolute inset-x-0 top-0">
      <div className="container mx-auto flex items-center px-4 md:px-8 justify-between py-4 shadow-[0px_4px_14px_0px_rgba(0,0,0,0.25)]">
        <div>
          <Image width={150} height={48} alt="logo" src={"/assets/logo.png"} />
        </div>
